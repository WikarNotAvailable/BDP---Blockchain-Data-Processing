...
try:
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        load(crypto_df, 'crypto') # Here we recalcualte both eth and btc df due to 'write'. We could use cache()/persist() to avoid it but it causes memory issues. We can also load eth and btc parquets
